...
const outSanitizedPath = "C:/Users/Lenovo/Downloads/Telegram Desktop/ai_notes.failed2.message-sanitized-expanded.json";
const outResultsPath = `${root}/.run/ai_notes-failed2-message-sanitized-expanded-results.json`;
const port = 8025;
const targetIndexes = new Set([3, 5]);
...
async function startBackend() {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    if (backend.exitCode !== null) throw new Error(`Backend exited early: ${err || out || backend.exitCode}`);
    try {
